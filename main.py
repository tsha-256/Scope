...
def Get_Data():
    ...
    File=ui.Firmware_disp.text()
    channel=ui.Att_disp.text()
    print(f"{File=} {channel=}")
    return Swp_mod,WLstart,WLend,Arg1,Arg2,Cycle,File,channel

def Auto_Start():
    Swp_mod,WLstart,WLend,Arg1,Arg2,Cycle,File,channel=Get_Data()
    functions.Auto_Start(Swp_mod,WLstart,WLend,Arg1,Arg2,Cycle,File,channel)
